...
function sshRun() {
	...
	sshFileLocal="$appRootDir/scripts/ssh-cmd.sh"
...
# Get app root folder (parent of the scripts folder containing config.sh)
appRoot="$(basename $(dirname -- "$scriptsDir"))"
appRootDir="$(dirname -- "$scriptsDir")"
